...
class AttachedFilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attached_file" do
    assert_difference('AttachedFile.count') do
      post attached_files_url, params: { attached_file: { filename: @attached_file.filename, size: @attached_file.size, work: @attached_file.work } }
    end
  ...
  test "should update attached_file" do
    patch attached_file_url(@attached_file), params: { attached_file: { filename: @attached_file.filename, size: @attached_file.size, work: @attached_file.work } }
